...
TEXT = {
   ...
   # Notes
    ...
    "PROFILE_DESC_QUICK_DIVER": {
        "en": "You fall asleep fast; an immediate dive into sleep that leaves little room for thinking.",
        "fr": "Vous vous endormez d’un seul coup; une plongée soudaine qui ne laisse à peine du temps pour penser.",
        "es": "Te duermes de golpe; una caída repentina que apenas deja tiempo para pensar.",
    },
    "PROFILE_DESC_FANTASIZER": {
        "en": "You build inner stories as you drift off; vivid, intentional scenarios that unfold until sleep takes over.",
        "fr": "Vous vous laissez porter par des histoires : des scènes volontairement imaginées qui vous portent jusqu’au sommeil.",
        "es": "Te dejas llevar por historias: escenas imaginadas a propósito que te acompañan hasta el sueño.",
    },
    "PROFILE_DESC_ARCHIVIST": {
        "en": "You fall asleep by revisiting the past; replaying moments, conversations, or scenes, sorting through memories before sleep.",
    ...
    "PROFILE_DESC_WORRIER": {
        "en": "Your mind loops before sleep, turning over the same concerns or unfinished thoughts in repeated passes before settling.",
        "fr": "Votre esprit tourne en boucle; des préoccupations ou pensées persistantes jusqu’à ce que le sommeil s’installe.",
        "es": "Tu mente gira en bucle; preocupaciones o pensamientos persistentes hasta que el sueño finalmente llega.",
    },
    "PROFILE_DESC_FREEWHEELER": {
        ...
        "fr": "Les pensées dirigées cèdent progressivement : les idées deviennent spontanées et changeantes, jusqu'au sommeil.",
        "es": "Los pensamientos dirigidos se desvanecen poco a poco: las ideas se vuelven espontáneas y cambiantes hasta que llega el sueño.",
    },
    "PROFILE_DESC_QUIET_MIND": {
        "en": "You drift into sleep with little crossing your mind, just a gentle fade-out of consciousness.",
        "fr": "L’activité mentale se fait silencieuse : vous glissez vers le sommeil avec l’esprit presque vide.",
        "es": "La actividad mental se vuelve silenciosa: te deslizas hacia el sueño con la mente casi vacía.",
    },
    "PROFILE_DESC_RADIO_TUNER": {
        "en": "Your mind shifts rapidly between thoughts and perceptions as you fall asleep, like tuning through mental stations and never staying in one one for long.",
        "fr": "Votre esprit change rapidement de forme—pensées et perceptions—sans jamais s’attarder sur un même contenu.",
    ...
    "PROFILE_DESC_STRATEGIST": {
        "en": "You organize your thoughts as you fall asleep, thinking ahead to what comes next.",
    ...
    "PROFILE_DESC_SENTINEL": {
        "en": "Your mind quiets down, but part of you stays lightly aware of the environment as you fall asleep.",
        "fr": "Votre esprit se calme, mais une légère vigilance demeure : vous percevez votre environnement tout en basculant vers le sommeil.",
        "es": "Tu mente se calma, pero queda una ligera vigilancia: percibes tu entorno mientras te dejas caer en el sueño.",
    },
    "PROFILE_DESC_FRAGMENTED_MIND": {
        "en": "Your mind breaks into fleeting fragments as you fall asleep: disconnected thoughts and fragments of images or sounds.",
        "fr": "Votre esprit se fragmente à l’endormissement : pensées déconnectées, bribes d’images ou de sons qui apparaissent et disparaissent.",
        "es": "Tu mente se fragmenta al quedarte dormido/a: pensamientos desconectados, fragmentos de imágenes o sonidos que aparecen y desaparecen.",
    },
    "PROFILE_DESC_PRAGMATIC": {
        ...
        "fr": "Vos pensées restent claires et concrètes, ancrées dans le quotidien plutôt que dans l’imaginaire ou l’étrange.",
        "es": "Tus pensamientos siguen claros y concretos, anclados en lo cotidiano más que en lo imaginario o lo extraño.",
    },
